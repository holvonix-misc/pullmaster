...
2. Switch ON for pullmaster
3. Visit the settings: https://travis-ci.org/holvonix-open/pullmaster/settings
...
* Scope: public_repo
* Name: pullmaster-GH_TOKEN_TRAVIS
...
* Scope: [none]
* Name: pullmaster-GH_RO_TOKEN_TRAVIS
...
## Push to GitHub
    ...
    git add . && git commit -m 'PROJECT SETUP FOR: pullmaster

    Template generated from https://github.com/holvonix-open/new-ball/76a4955450f0c0e0ee7f2c40b662f1f7bd4fa73c
...
4. Codacy - https://www.codacy.com/app/holvonix-open and sync and enable, and add the badge too. Then enable all integrations at https://www.codacy.com/app/holvonix-open/pullmaster/settings/integrations
